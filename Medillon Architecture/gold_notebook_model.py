...
df_src = spark.sql('''
select DISTINCT(Model_ID) as Model_ID, model_category from parquet.`abfss://silver@ragcardatalake.dfs.core.windows.net/carsales`
''')
...
# Incremental RUN
if spark.catalog.tableExists('cars_catalog.gold.dim_model'):
    delta_tbl = DeltaTable.forPath(spark,"abfss://gold@ragcardatalake.dfs.core.windows.net/dim_model")
...
#Initial Run
    ...
    df_final.write.format("delta")\
         .mode("overwrite")\
             .option("path","abfss://gold@ragcardatalake.dfs.core.windows.net/dim_model")\
