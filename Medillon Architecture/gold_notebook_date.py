...
df_src = spark.sql('''
select DISTINCT(Date_ID) as Date_ID from parquet.`abfss://silver@ragcardatalake.dfs.core.windows.net/carsales`
''')
...
# Incremental RUN
if spark.catalog.tableExists('cars_catalog.gold.dim_date'):
    delta_tbl = DeltaTable.forPath(spark,"abfss://gold@ragcardatalake.dfs.core.windows.net/dim_date")
...
#Initial Run
    ...
    df_final.write.format("delta")\
         .mode("overwrite")\
             .option("path","abfss://gold@ragcardatalake.dfs.core.windows.net/dim_date")\
